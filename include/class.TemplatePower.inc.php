...
// print_r($tplvar);
        // echo $this->{$tplvar}["content"];
        // print_r($this->{$tplvar}["content"]);
...
// $tplvar = $this->__prepareTemplate($this->tpl_base[0], $this->tpl_base[1]);
// Deprecated: Creation of dynamic property TemplatePower::$tpl_rawContent1 is deprecated in /var/www/vhosts/pohpunpanyafoundation.org/dev.pohpunpanyafoundation.org/include/class.TemplatePower.inc.php on line 150
