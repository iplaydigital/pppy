...
function isLocalhostReference($reference) {
    return (strpos($reference, 'localhost') !== false || strpos($reference, '127.0.0.1') !== false);
}

// Example usage
$yourReference = $url_main;
if (isLocalhostReference($yourReference)) {
...
if ($_POST['action'] == 'loadSchool') {
    ...
    echo "This is not a localhost reference.";
}
